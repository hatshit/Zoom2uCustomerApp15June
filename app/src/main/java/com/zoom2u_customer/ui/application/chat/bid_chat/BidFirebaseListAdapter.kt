...
abstract class  BidFirebaseListAdapter<T>(
    ...
    override fun getView(i: Int, view: View?, parent: ViewGroup): View {
        ...
        val previousChatTimeStamp:String = if(i==0) {
            ...
            (mModels[i-1] as BidChat).timestamp.toString()
        val model = mModels[i]
    ...
    fun checkSenderIsAdmin(position: Int): String {
        ...
        senderIsAdminStr = (mModels[position] as BidChat).sender.toString()
    ...
    init {
        ...
        mListener = this.mRef!!.addChildEventListener(object : ChildEventListener {
            override fun onChildAdded(dataSnapshot: DataSnapshot, previousChildName: String?) {
                try {
                    val model: T? = dataSnapshot.getValue(this@BidFirebaseListAdapter.mModelClass)
                    val key: String? = dataSnapshot.key
            ...
            override fun onChildChanged(dataSnapshot: DataSnapshot, s: String?) {
                ...
                val key: String? = dataSnapshot.key
                val newModel: T? = dataSnapshot.getValue(this@BidFirebaseListAdapter.mModelClass)
